  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-6 py-16 text-center">
        <div className="w8-16 h-16 rounded-2xl mx-auto mb-6 flex items-center justify-center" style={{background:'#e0f7f4'}}>
        ...
        <p className="text-gray-500 mb-8">Enter your Shopify store domain to get started.</p>
        <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm text-left">
          ...
          <div className="flex gap-3">
            <input type="text" value={shopDomain} onChange={e => setShopDomain(e.target.value)} placeholder="yourstore" className="flex-1 px-4 py-3 rounded-lg border border-gray-200 text-gray-900 focus:outline-none text-sm"/>
            <span className="flex items-center text-gray-400 text-sm">.myshopify.com</span>
          </div>
          <button onClick={handleConnect} disabled={loading || !shopDomain} className="w-full mt-4 py-3 rounded-lg text-white font-semibold text-sm" style={{background: loading || !shopDomain ? '#94a3b8' : '#1a2f5e'}}>
